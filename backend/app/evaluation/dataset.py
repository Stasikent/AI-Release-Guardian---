...
EXTENDED_CASES=[
_case("button_disabled",'<button id="pay">Pay</button>','<button id="pay" disabled>Pay</button>',0,0,1,1),
...
_case("aria_label_changed",'<button id="menu" aria-label="Open menu"></button>','<button id="menu" aria-label="Menu"></button>',0,0,1,1),
...
_case("input_required",'<input id="email">','<input id="email" required>',0,0,1,1),
_case("checkbox_checked",'<input id="tos" type="checkbox">','<input id="tos" type="checkbox" checked>',0,0,1,1),
_case("input_readonly",'<input id="user">','<input id="user" readonly>',0,0,1,1),
_case("aria_expanded",'<button id="menu" aria-expanded="false">Menu</button>','<button id="menu" aria-expanded="true">Menu</button>',0,0,1,1),
_case("aria_checked",'<input id="x" role="checkbox" aria-checked="false">','<input id="x" role="checkbox" aria-checked="true">',0,0,1,1),
_case("role_changed",'<button id="tab" role="button">Tab</button>','<button id="tab" role="tab">Tab</button>',0,0,1,1),
]
