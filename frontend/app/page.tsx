...
export default function Home(){
 ...
 useEffect(()=>{load()},[]);
 async function create(e:FormEvent){e.preventDefault();setError("");try{await api.createProject(name,description);setName("");setDescription("");load()}catch(e){setError(String(e))}}
