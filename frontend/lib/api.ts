...
export type BatchScanResult = { role:"baseline"|"current"; requested_count:number; succeeded_count:number; failed_count:number; results:{route:string;status:"SUCCEEDED"|"FAILED";scan_id:number|null;error:string|null;error_code:string|null}[] };
